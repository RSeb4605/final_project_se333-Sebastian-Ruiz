...
The repository includes a lightweight tester agent prompt at `.github/prompts/tester.prompts.md` that documents the intended automated workflow:
...
---
If you want, I can add a small PowerShell script to detect non-UTF-8 Java files or add a Maven wrapper to make `mvn` available without installing Maven system-wide. Tell me which you'd prefer.
